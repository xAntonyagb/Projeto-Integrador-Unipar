...
export class NotificacaoService {
  ...
  getAll(page: number = 0, size: number = 10, sort?: string): Observable<PaginacaoResponse<NotificacaoResponse>> {
    ...
    return this.http.get<PaginacaoResponse<NotificacaoResponse>>(`${this.apiUrl}/notificacao/all`, { params });
  }

  getById(id: number): Observable<NotificacaoResponse> {
    return this.http.get<NotificacaoResponse>(`${this.apiUrl}/notificacao?id=${id}`);
  }
