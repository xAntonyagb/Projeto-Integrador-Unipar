...
export class RelatoriosService {
  ...
  getGeral(): Observable<RelatoriosGeraisResponse> {
    return this.http.get<RelatoriosGeraisResponse>(`${this.apiUrl}/relatorios/geral`);
  }
  ...
  getMensal(mes?: number): Observable<RelatoriosMensaisResponse> {
    ...
    return this.http.get<RelatoriosMensaisResponse>(`${this.apiUrl}/relatorios/mensal`, { params });
  }
  ...
  getAnual(ano?: number): Observable<RelatoriosAnoResponse> {
    ...
    return this.http.get<RelatoriosAnoResponse>(`${this.apiUrl}/relatorios/anual`, { params });
  }
  ...
  getAll(mes?: number, ano?: number): Observable<RelatoriosFullResponse> {
    ...
    return this.http.get<RelatoriosFullResponse>(`${this.apiUrl}/relatorios/all`, { params });
  }
