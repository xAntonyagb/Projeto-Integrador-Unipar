...
export class TarefaService {
  ...
  getAll(page: number = 0,
         ...
         status?: StatusTarefa,
         arquivado?: boolean) : Observable<PaginacaoResponse<TarefaResponse>>
  {
    ...
    if (arquivado !== undefined) params = params.set('arquivado', arquivado.toString());

    return this.http.get<PaginacaoResponse<TarefaResponse>>(`${this.apiUrl}/tarefa/all`, { params });
  }
